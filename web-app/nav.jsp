    ...
    <div id='mainHeadDiv'>
    	<div id='headTab' class='tabs'>
           <%-- <div id="safetyMonitor" class='tabItem' url="/port/main.html?sys=safetyMonitor">安全监控系统</div>--%>
            <div id="mechannismForcast" class='tabItem' url="/jinling/main.html?sys=mechannismForcast">机构健康监测</div>
            <div id="structForcast" class='tabItem ' url="/jinling/main.html?sys=structForcast">结构健康监测</div>
            <div class='tabItem mainselected' url="/riskreportJinling">健康诊断预报</div>
            <%--<div class='tabItem' url="/inspectPort">智能点检维修</div>--%>
            <div id="integrateManagement" class='tabItem' url="/jinling/main.html?sys=integrateManagement">安全技术档案</div>
  	</div>
